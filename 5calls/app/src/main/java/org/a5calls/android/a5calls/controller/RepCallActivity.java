...
public class RepCallActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(KEY_LOCAL_OFFICES_EXPANDED,
                binding.localOfficeSection.getVisibility() == View.VISIBLE);
    }
    ...
    private void setupContactUi(int index, boolean expandLocalSection) {
        ...
        if (expandLocalSection) {
            ...
            binding.localOfficeSection.setVisibility(View.GONE);
            binding.localOfficeSection.removeViews(1, binding.localOfficeSection.getChildCount() - 1);
    ...
    private void expandLocalOfficeSection(Contact contact) {
        binding.localOfficeButton.setVisibility(View.INVISIBLE);
        binding.localOfficeSection.setVisibility(View.VISIBLE);
        binding.localOfficePrompt.setText(String.format(getResources().getString(
        ...
        for (int i = 0; i < contact.field_offices.length; i++) {
            ...
            binding.localOfficeSection.addView(localOfficeInfo);
        }
    }
