    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(mIssue.link)) {
            ...
            if ((TextUtils.isEmpty(mIssue.linkTitle))) {
                binding.linkText.setText(mIssue.link);
            } else {
                binding.linkText.setText(Html.fromHtml(
                        String.format("<a href=\"%s\">%s</a>", mIssue.link, mIssue.linkTitle)));
            }
        } else {
            binding.linkText.setVisibility(View.GONE);
        }
            ...
            public void onStateChanged(@NonNull View bottomSheet, int newState) {
                if (newState == BottomSheetBehavior.STATE_SETTLING ||
                    ...
                    wasAtBottom = binding.scrollView.getHeight() + binding.scrollView.getScrollY() >=
                            binding.issueTextSection.getMeasuredHeight();
                    mIsAnimating = true;
                } else {
                    mIsAnimating = false;
